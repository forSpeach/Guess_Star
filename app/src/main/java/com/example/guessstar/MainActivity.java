...
/* Приложение сделано по видео-курсу А. Сумина
"Андроид разработка с нуля до Junior"
 */
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickAnswer(View view) {
        ...
        if(Integer.parseInt(tag) == numberOfRightAnswer) {
            ...
            Toast.makeText(this, "Неверно, правильный ответ: " +  names.get(numberOfQuestion), Toast.LENGTH_LONG).show();
        }
        playGame();
    }
